...
import ru.gb.repository.MarkNoteRepository;
import ru.gb.service.FileGetway;
...
public class MarkNoteController {
    ...
    private final FileGetway fileGetway;
    ...
    public ResponseEntity<MarkNote> createMark(@RequestBody MarkNote markNote) {
        fileGetway.writeToFile(markNote.getTitle()+".txt", markNote.getContent());
